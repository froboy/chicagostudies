...
<div class="container-16 clearfix article"">
  <div id="main" class="region clearfix grid-11">
    ...
    <div id="content">
	    <?php
	     ...
	     print "<h3>".$node->field_subtitle['und'][0]['safe_value']."</h3></div>";
	     print "<span class=\"date\">".date("F j, Y", $node->revision_timestamp)."</span></div>"; 
  ...
  <div id="sidebar" class="region clearfix grid-5">
    <div class="photo">
      <img src="<?php print "../sites/default/files/images/features/".$node->field_article_photo['und'][0]['filename']; ?>" alt="<?php print $node->field_article_photo['und'][0]['alt']; ?>" />
